// src/components/AttendanceOverview/SoftwareDeveloperOverview.jsx
import React, { useEffect, useState } from "react";
import { useNavigate, useParams } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { MdEventAvailable, MdEventBusy, MdAccessTime } from "react-icons/md";

import { fetchSoftwareDeveloperByIdAPI } from "../../redux/services/softwareDevOverviewService";

// Dev attendance slice (separate from HR)
import {
      ...
      <div className="bg-white rounded-2xl shadow border border-gray-200 overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6">
          ...
          <input
            type="month"
            value={month || ""}
            onChange={(e) => dispatch(setDevAttendanceMonth(e.target.value))}
