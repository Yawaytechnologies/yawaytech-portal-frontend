            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="relative w-64">
                <input
                  ...
                  className={`peer h-8 px-2 text-xs rounded-md border ${
                    emailTouched
                      ? isEmailValid
                        ? "border-green-400"
                        : "border-red-400"
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="relative w-64">
                <input
                  ...
                  className="peer h-8 px-2 text-xs rounded-md border border-blue-200 bg-blue-50 outline-none focus:border-2 focus:border-blue-500 transition w-full"
                  value={password}
