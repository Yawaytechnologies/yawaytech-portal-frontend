// src/redux/services/marketingOverviewService.js
const baseURL =
  import.meta.env.VITE_API_BASE_URL ||
  "https://yawaytech-portal-backend-python-2.onrender.com/";

/**
 * Fetch a Marketing employee by ID (business key / employee_id).
 * Uses the same endpoint shape as HR: GET /api/employees/:id
 */
export const fetchMarketingByIdAPI = async (employeeId) => {
  ...
  // Normalized shape (mirrors hrOverviewService)
  return {
